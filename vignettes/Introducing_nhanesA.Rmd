...
RIAGENDR, like most categorical variables, is a coded field. That is, the values 1,2 correspond to coded values (Male, Female). If desired, we can use nhanesTranslate to apply a code translation to demo\_d directly by assigning data=demo\_d. That will replace the original values with the coded values.
```{r bmx1, eval=FALSE}
